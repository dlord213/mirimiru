...
export default function ViewMangaChapter() {
  ...
  return (
    <main className="relative mx-auto flex h-screen max-w-7xl flex-col gap-4">
      ...
      <div className="absolute bottom-4 z-50 flex w-full max-w-xl items-center gap-4 self-center rounded-3xl bg-gray-100 p-4 shadow-lg dark:bg-stone-700 dark:text-stone-50 dark:shadow-none">
